...
date: 2017-02-20
lastmod: 2020-07-15
linktitle: How to Add Credential Parameters to PowerShell Functions
toc: true
type:
- post
- posts
title: How to Add Credential Parameters to PowerShell Functions
tags: ["PowerShell","Credentials","mental-health","digital-minimalism"]
categories: ["how-to"]
---
...
![GetCredAtRunTime](/img/posts/AddCredentialsToPowerShellFunction/GetCredAtRunTime.gif "GetCredAtRunTime")
...
![GetCredsPrompt](/img/posts/AddCredentialsToPowerShellFunction/GetCredsPrompt.gif "GetCredsPrompt")
...
## <a id="Dealing-with-Legacy-Cmdlets"></a> Dealing with Legacy Cmdlets
