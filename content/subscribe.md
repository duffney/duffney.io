...
2. Your future needs a direction, not an operating manual

3. Your employer isn’t your success coach

4. Learn enough to practice, practice until you understand

5. Enjoy the process

6. Action and direction are the connecting points of progress

7. The only thing that matters is the distance you’ve traveled
```

<br>
<p align="center">
<b>Subscribe</b> to <b>the 4-hour engineer</b> email list.
</p>
